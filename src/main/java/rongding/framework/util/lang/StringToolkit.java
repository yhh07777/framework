...
public final class StringToolkit {
	...
	public static int getLastSeparator(String string) {
		for (int i = string.length()-1; i >0 ; i--) {
//			System.out.println("i="+i+",ch="+string.charAt(i));
			if (string.charAt(i)=='/' || "\\".equals(string.indexOf(i))) {
				return i;
			}
		}
		return -1;
