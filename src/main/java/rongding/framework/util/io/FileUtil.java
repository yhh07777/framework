...
import rongding.framework.util.lang.StringToolkit;

public class FileUtil {
	public static void save(File fromFile, String toPath) {
		File toFile = new File(toPath);
		save(fromFile, toFile);
	}

	public static void save(File fromFile, File toFile) {
		try {
	...
	public static void save(String fromPath, String toPath) {
		File fromFile = new File(fromPath);
		File toFile = new File(toPath);
		save(fromFile, toFile);
	}

	public static void save(File fromFile, String parentPath, String imageName) {
		try {
			File toFile = new File(parentPath + File.separator + imageName);
			FileUtils.copyFile(fromFile, toFile);
		} catch (IOException e) {
			e.printStackTrace();
			throw new RuntimeException("save file error!", e);
